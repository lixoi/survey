...
func NewSwaggerAPI(spec *loads.Document) *SwaggerAPI {
	return &SwaggerAPI{
		...
		IchSurveyICHSurveySetAnswerHandler: i_c_h_survey.ICHSurveySetAnswerHandlerFunc(func(params i_c_h_survey.ICHSurveySetAnswerParams) middleware.Responder {
			return middleware.NotImplemented("operation i_c_h_survey.ICHSurveySetAnswer has not yet been implemented")
		}),
		IchSurveyICHSurveyStartSurveyHandler: i_c_h_survey.ICHSurveyStartSurveyHandlerFunc(func(params i_c_h_survey.ICHSurveyStartSurveyParams) middleware.Responder {
...
type SwaggerAPI struct {
	...
	// IchSurveyICHSurveySetAnswerHandler sets the operation handler for the i c h survey set answer operation
	IchSurveyICHSurveySetAnswerHandler i_c_h_survey.ICHSurveySetAnswerHandler
	// IchSurveyICHSurveyStartSurveyHandler sets the operation handler for the i c h survey start survey operation
	IchSurveyICHSurveyStartSurveyHandler i_c_h_survey.ICHSurveyStartSurveyHandler
...
func (o *SwaggerAPI) Validate() error {
	...
	if o.IchSurveyICHSurveySetAnswerHandler == nil {
		unregistered = append(unregistered, "i_c_h_survey.ICHSurveySetAnswerHandler")
	}
	if o.IchSurveyICHSurveyStartSurveyHandler == nil {
		unregistered = append(unregistered, "i_c_h_survey.ICHSurveyStartSurveyHandler")
	}
...
func (o *SwaggerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/v1/set_answer/{userId}"] = i_c_h_survey.NewICHSurveySetAnswer(o.context, o.IchSurveyICHSurveySetAnswerHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/v1/start_survey/{userId}"] = i_c_h_survey.NewICHSurveyStartSurvey(o.context, o.IchSurveyICHSurveyStartSurveyHandler)
}
